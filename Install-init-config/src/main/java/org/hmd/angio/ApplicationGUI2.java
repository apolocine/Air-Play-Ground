...
public class ApplicationGUI2 extends JFrame {

	
	 private final static Logger LOGGER = Logger.getLogger(ApplicationGUI2.class.getName());
...
//connexion à la base de donnée existe 
					if (applicationLoginSuccessful) {
						...
						JOptionPane.showMessageDialog(ApplicationGUI2.this,
...
//        // Ajoutez ici le code pour le démarrage effectif de votre application
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new ApplicationGUI2());
	}
}
