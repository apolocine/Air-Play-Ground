...
public class LoginFormMain extends JFrame {
	...
	private void performCreateUser(ActionEvent event) {
		...
		JOptionPane.showMessageDialog(this, "Login first as admin to Create user ", "Create user",
	...
	private void performLogin(ActionEvent event) {
		...
		if (authenticated != null) {
			...
			ConnectedUser.setUser(authenticated);
			 
			UserRepository repo = new UserRepository(vonn);
